...
let
  sources = {
    ...
    "remark-validate-links-10.0.4" = {
      ...
      version = "10.0.4";
      src = fetchurl {
        url = "https://registry.npmjs.org/remark-validate-links/-/remark-validate-links-10.0.4.tgz";
        sha512 = "oNGRcsoQkL35WoZKLMMBugDwvHfyu0JPA5vSYkEcvR6YBsFKBo4RedpecuokTK1wgD9l01rPxaQ9dPmRQYFhyg==";
      };
    };
    "repeat-string-1.6.1" = {
      name = "repeat-string";
    ...
    "vfile-reporter-json-2.0.2" = {
      ...
      version = "2.0.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/vfile-reporter-json/-/vfile-reporter-json-2.0.2.tgz";
        sha512 = "L9s5WLxOFCygydfGAaItZtgd2eQi/HVgo0ChYVbm02EnFMzybr3PZYUCmSqcCWMKWCX5FLjvSwjkSVS47Eph6g==";
      };
    };
    "vfile-sort-2.2.2" = {
      name = "vfile-sort";
...
in
{
  "remark-lint-wrapper-./" = nodeEnv.buildNodePackage {
    name = "remark-lint-wrapper";
    packageName = "remark-lint-wrapper";
    version = "1.0.0";
    src = ./.;
    dependencies = [
      ...
      sources."remark-validate-links-10.0.4"
      ...
      sources."vfile-reporter-json-2.0.2"
